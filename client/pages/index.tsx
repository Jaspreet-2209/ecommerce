...
<div className="row" style={{maxWidth:"100%"}}>
        <div className="col-lg-6" id="head" style={{marginTop:"90px"}}>
          ...
          <Link href="./register"> <button type="button" style={{background:"#7AA93C",marginTop:"20px",width:"132px"}}className="btn btn-dark btn-lg download-button"><a className="a3" href="#"><FaUserLarge /></a><span className="ctabuttons">{data.hero.ctaButtons[1].text}</span></button></Link>
        </div>
